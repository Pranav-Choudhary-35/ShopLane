...
const CreateProduct = () => {
  ...
  const inputClass = "w-full bg-transparent outline-none py-4 text-sm transition-colors duration-300 placeholder:text-[#8b7d72]";
  const inputStyle = { color: '#1b1c1a', borderBottom: '1px solid #8b7d72', fontFamily: "'Inter', sans-serif" };
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 lg:items-start">
              ...
              <div className="flex flex-col gap-12">
                ...
                <div className="flex flex-col gap-3">
                  <label className="text-[10px] uppercase tracking-[0.2em] font-medium" style={{ color: '#5A5550' }}>
                    Price
                  </label>
                  <div className="flex gap-5 items-end">
                    {/* Amount */}
                    <div className="flex flex-col gap-1 flex-[3]">
                      <span className="text-[9px] uppercase tracking-[0.18em]" style={{ color: '#7A6E63' }}>Amount</span>
                      <input
                        id="cp-priceAmount"
                        type="number"
                        name="priceAmount"
                    ...
                    <div className="flex flex-col gap-1 flex-[1]">
                      <span className="text-[9px] uppercase tracking-[0.18em]" style={{ color: '#7A6E63' }}>Currency</span>
                      <select
                        id="cp-priceCurrency"
                        name="priceCurrency"
              ...
              <div className="flex flex-col gap-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px]" style={{ color: '#7A6E63' }}>
                ...
                {images.length < MAX_IMAGES && (
                  <div
                    ...
                    style={{
                      borderColor: isDragging ? '#C9A96E' : '#8b7d72',
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{ borderColor: isDragging ? '#C9A96E' : '#8b7d72', color: isDragging ? '#C9A96E' : '#7A6E63' }}
                    >
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-[10px] uppercase tracking-[0.15em] mt-2" style={{ color: '#7A6E63' }}>
